...
export default function Soon() {
  ...
  return (
    ...
    >
      <div className="relative mt-16 hover:scale-105 text-center transition-opacity duration-200 mx-10 md:mx-0 justify-center items-center flex h-96 bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
