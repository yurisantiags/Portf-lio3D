...
export default function Soon(){
  useEffect(() => {
    ...
    return(
        <div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" className=" mb-8 md:mb-32 flex rounded-lg  lg:max-w-5xl lg:w-full lg:mb-0 lg:text-left">
      <a
        href=""
