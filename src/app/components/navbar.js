    ...
    <nav className="bg-black bg-opacity-0 fixed w-full top-0 z-10">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-4">
          <button className="text-white opacity-75 mt-5 text-sm hover:underline transition-all" onClick={scrollToTop}>
            Home
          </button>
          <button className="text-white opacity-75 mt-5 text-sm hover:underline transition-all" onClick={() => scrollToSection('about')}>
            About
          </button>
          <button className="text-white opacity-75 mt-5 text-sm hover:underline transition-all" onClick={() => scrollToSection('contacts')}>
            Contacts
          </button>
        </div>
